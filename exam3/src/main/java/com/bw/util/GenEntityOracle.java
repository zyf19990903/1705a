...
public class GenEntityOracle {
    ...
    private String authorName = "zyf";// 作者名字
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/one?user=root&password=1999&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("t_engineer","Engineer","one").init();  
        new GenEntityOracle("t_profession","Profession","one").init();  
